      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            lineHeight: '1.8',
            maxWidth: 'none',
            h1: { fontFamily: 'Syne, system-ui, sans-serif', color: '#0D0D0D', fontWeight: '800', letterSpacing: '-0.02em' },
            h2: { fontFamily: 'Syne, system-ui, sans-serif', color: '#0D0D0D', fontWeight: '700', letterSpacing: '-0.02em', marginTop: '2.5rem' },
            h3: { fontFamily: 'Syne, system-ui, sans-serif', color: '#0D0D0D', fontWeight: '600', letterSpacing: '-0.01em' },
            h4: { fontFamily: 'Syne, system-ui, sans-serif', color: '#0D0D0D', fontWeight: '600' },
            ...
            'thead th': { color: '#FFFFFF', backgroundColor: '#1B3A5C', fontWeight: '600', fontFamily: 'Syne, sans-serif', letterSpacing: '-0.01em' },
