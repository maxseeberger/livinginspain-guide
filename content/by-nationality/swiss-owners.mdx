...
readingTime: 7
simplifySimple: |
  Swiss owners pay the 24% non-EU Modelo 210 rate (Switzerland is not in the EU). However, Switzerland IS in the Schengen Area, so there's no 90-day limit on visits to Spain — Swiss citizens have free movement within Schengen. The 1966 Switzerland–Spain tax treaty covers double taxation, though it's older than the German and UK treaties.
simplifyBullet: |
  • **24% Modelo 210 rate (non-EU):** Switzerland is outside the EU for tax purposes.
  • **No 90-day limit:** Switzerland is in Schengen, so Swiss citizens can visit freely.
  • **Switzerland–Spain DTA 1966** prevents double taxation on the same income.
  • **EHIC equivalent available** for emergency healthcare during stays in Spain.
  • **Swiss driving licence valid in Spain:** no exchange needed while non-resident.
simplifyExample: |
  Swiss owner spends 4 months/year in Mallorca — no problem, Schengen member. Pays Modelo 210 at 24% on €1,760 imputed income = €422/year. Declares on Swiss tax return using DTA exemption. No double tax. Uses Swiss EHIC equivalent card for GP visit during stay.
---
