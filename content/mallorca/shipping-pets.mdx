...
readingTime: 7
simplifySimple: |
  Bringing your dog or cat to Mallorca is straightforward if you follow the rules. EU residents need an EU Pet Passport, which your vet issues. British owners need to meet the UK Pet Travel Scheme requirements: microchip, rabies vaccination, and a tapeworm treatment for dogs within 1–5 days before travel. No quarantine if requirements are met.
simplifyBullet: |
  • **EU owners: EU Pet Passport from your vet** — covers microchip, rabies, and treatments.
  • **UK owners: microchip + rabies jab + tapeworm treatment** + AHC health certificate.
  • **No quarantine if paperwork is correct:** Spain does not quarantine compliant pets.
  • **Most airlines carry pets in cabin (small) or hold:** check airline policy before booking.
  • **Register microchip with Spanish vet on arrival:** required for pets staying long-term.
simplifyExample: |
  British owner flies her dog to Mallorca from Heathrow. Vet issues AHC health certificate 48 hours before travel. Dog has valid rabies vaccination and microchip. Tapeworm treatment given 3 days before. Flies as cabin pet on Vueling (€50 fee). Arrives in Palma — customs check papers, wave through. No quarantine.
---
