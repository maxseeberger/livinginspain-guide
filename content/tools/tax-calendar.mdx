...
readingTime: 7
simplifySimple: |
  A complete list of every tax deadline relevant to non-resident property owners in Spain. The most critical: Modelo 210 must be filed by 31 December each year. IBI is paid in autumn (varies by municipality). Wealth tax by 30 June. Miss a deadline and you'll pay surcharges — set calendar reminders now.
simplifyBullet: |
  • **Modelo 210 (annual): 31 December** — the single most important deadline.
  • **Modelo 210 (rental income): quarterly** — 20 April, July, October, January.
  • **IBI: typically October–November** — varies by municipality, set up direct debit.
  • **Patrimonio (Modelo 714): 30 June** — applies if Spanish assets exceed €700,000.
  • **Late filing adds 5–20% surcharge** depending on how long after the deadline.
simplifyExample: |
  German owner's annual tax reminders: 1 October — check IBI direct debit cleared. 30 November — send property details to gestoría for Modelo 210. 31 December — Modelo 210 filed and paid. 30 June (following year) — Modelo 714 wealth tax filed if assets over €700,000. Total annual tax admin: ~2 hours + gestoría fee.
---
