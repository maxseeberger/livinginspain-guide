...
readingTime: 5
simplifySimple: |
  Every car in Spain must have at least third-party liability insurance (seguro obligatorio). Fully comprehensive (todo riesgo) is optional but worth it for a newer car. As a non-resident with a foreign address, most Spanish insurers will cover you — bring your foreign no-claims certificate for a better rate. Keep your green card (carta verde) in the car at all times.
simplifyBullet: |
  • **Third-party insurance mandatory** for all cars driven on Spanish roads.
  • **Todo riesgo (fully comp) recommended** for newer or higher-value cars.
  • **Spanish insurers accept foreign addresses:** non-residency is not a barrier.
  • **Bring no-claims certificate** from your home country insurer for a better premium.
  • **Keep carta verde (green card) in the car** — required for any police check.
simplifyExample: |
  British owner buys 2-year-old car in Mallorca for €18,000. Gets quote from Mapfre: fully comprehensive €680/year with UK no-claims history. Third-party only would be €290/year. She chooses fully comp given car value. Gets carta verde — keeps it in glovebox for any police check.
---
