...
readingTime: 7
simplifySimple: |
  British (and non-EU) property owners can only spend 90 days out of any 180-day period in the Schengen Area — which includes Spain. Days in any Schengen country count together. This replaced free movement after Brexit. It doesn't affect your right to own property, but it limits how long you can actually stay.
simplifyBullet: |
  • **Max 90 days in any 180-day rolling window:** not a fixed calendar period — it rolls continuously
  • **Counts all Schengen countries together:** days in France, Italy, Germany all count against your allowance
  • **Applies to UK, US, Canadian, Swiss owners:** and most other non-EU nationals
  • **Does not affect property ownership rights:** you can own a home; you just can't stay indefinitely
  • **Violations risk entry bans:** border authorities can bar re-entry if you've overstayed
simplifyExample: |
  British owner arrives in Mallorca 1 June. By 29 August she's used 90 days. She must leave all Schengen countries until at least 28 November (when 180 days have passed since 1 June). Visiting France, Italy or Germany also counts against her 90 days.
---
