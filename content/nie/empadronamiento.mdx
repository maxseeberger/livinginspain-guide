...
readingTime: 7
simplifySimple: |
  Registering on the local residents' list (padrón) at your Spanish town hall. It proves you have an address in Spain and is required for some services. For non-residents who only visit occasionally, it's optional but can be useful. For anyone living in Spain full-time, it's mandatory and needed for the TIE card, school enrollment, and more.
simplifyBullet: |
  • **Registration at ayuntamiento with proof of address:** bring passport and escritura or rental contract
  • **Required for TIE card and school enrollment:** residents cannot complete their TIE without it
  • **Optional for non-residents visiting only:** but can be useful for accessing local services
  • **Free and quick:** most town halls process it on the spot or within a few days
  • **Certificate lasts 3 months:** request a fresh one each time you need it for official purposes
simplifyExample: |
  British owner spends 3 months/year in Mallorca. She registers at the Andratx town hall with her passport and escritura (property deeds). Gets empadronamiento certificate. Uses it to register her child at the local school for the months they're in Mallorca.
---
