...
readingTime: 6
simplifySimple: |
  NIE is your Spanish identification number — a letter and 8 digits. NIF is the same number used for tax purposes. TIE is a biometric plastic card that residents get instead of the old paper NIE certificate. As a non-resident property owner, you have a NIE (paper certificate) which also functions as your NIF for taxes.
simplifyBullet: |
  • **NIE = identification number (letter + 8 digits):** your permanent Spanish foreign ID number
  • **NIF = same number used for tax:** when filing Modelo 210, your NIF is just your NIE number
  • **TIE = plastic card for residents only:** biometric card issued to people legally living in Spain
  • **Non-residents keep paper NIE certificate:** the green A4 document is all you need
  • **All three refer to the same number:** X1234567A — just used in different contexts
simplifyExample: |
  British owner receives green A4 paper certificate with number X1234567A — this is her NIE. When she files Modelo 210, she enters X1234567A as her NIF. If she later becomes a Spanish resident, she'd exchange it for a TIE plastic card.
---
