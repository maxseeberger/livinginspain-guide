...
readingTime: 8
simplifySimple: |
  In Mallorca, renting your property to tourists requires an ETV licence — and the island has effectively stopped issuing new ones in most areas since 2017. If your property doesn't already have a licence, you almost certainly can't legally rent it short-term to tourists. The fines for unlicensed rental are up to €40,000+.
simplifyBullet: |
  • **ETV licence required for tourist rental in Mallorca:** without it, any short-term tourist rental is illegal
  • **Moratorium means almost no new licences available:** only detached rural properties in specific zones qualify
  • **Existing licences can sometimes be sold with property:** check the listing carefully and verify with the Consell
  • **Fines up to €40,900 for illegal rental:** Airbnb listings without a licence are regularly reported and fined
  • **Long-term rental (11+ months) is unaffected:** no ETV needed for annual or longer contracts
simplifyExample: |
  British owner buys Mallorca villa for €600,000 hoping to Airbnb it. Checks with Consell de Mallorca — no ETV licence exists. Without one, she cannot legally advertise on Airbnb for stays under 1 month. She switches to long-term rental instead, which requires no ETV licence.
---
