...
readingTime: 6
simplifySimple: |
  Spanish inheritance tax is set by each region, so what you pay depends entirely on where your property is. The Balearics, Madrid, and Andalusia all offer near-100% reductions for direct family. Catalonia is much more expensive. If you own in multiple Spanish regions, each property is taxed under that region's rules.
simplifyBullet: |
  • **Tax rates set by autonomous community:** the region where the property sits determines the applicable rules
  • **Balearics 99% reduction for direct family:** among the most generous regimes in all of Spain
  • **Madrid and Andalusia also very generous:** effective rates near zero for children and spouse
  • **Catalonia significantly higher:** no equivalent blanket exemption; effective rates can reach 15–30%
  • **Non-residents without regional ties use national rates:** national fallback applies if no clear regional connection
simplifyExample: |
  British owner has two properties: Mallorca apartment (€400,000) and Barcelona apartment (€400,000). Mallorca inheritance: €400,000 to daughter, ~€250 tax (Balearic exemption). Barcelona: same €400,000, same daughter — Catalonia rates apply, potentially €15,000–€30,000 tax depending on circumstances.
---
