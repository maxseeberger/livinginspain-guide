...
readingTime: 7
simplifySimple: |
  Giving your property to your children during your lifetime (donation) instead of leaving it in your will sounds attractive — but in the Balearics, it's usually worse. The Balearic 99% inheritance tax exemption applies at death, not on lifetime gifts. If you donate the property now, your children pay more tax than if they just inherited it.
simplifyBullet: |
  • **Donation = gift during your lifetime (Modelo 651):** taxed as a gift at the time of transfer
  • **Inheritance = on death (Modelo 650):** taxed under inheritance rules at time of death
  • **Balearic 99% exemption applies to inheritance not donation:** donations don't get the same reduction
  • **Capital gains tax also triggered on donation (treated as sale):** the donor pays CGT on any gain
  • **Inheritance usually better in the Balearics:** wait — the math strongly favours inheriting over gifting
simplifyExample: |
  German owner wants to give Mallorca flat (€500,000) to daughter now. Donation: daughter pays ~€25,000 gift tax (no Balearic exemption). Plus owner pays Spanish CGT on any gain over purchase price. If he waits and she inherits on death: ~€250 total Spanish tax. Waiting saves ~€25,000+.
---
