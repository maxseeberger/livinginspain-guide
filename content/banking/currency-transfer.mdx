...
readingTime: 6
simplifySimple: |
  Every time you move money from Germany or the UK to your Spanish account — whether to pay IBI, buy property, or fund renovations — the exchange rate matters. Your bank's spread is typically 2–3%. Specialist providers like Wise charge 0.4–0.7%. On a €50,000 transfer, that's €1,300–€1,800 saved.
simplifyBullet: |
  • **Bank spreads typically 2–3%:** expensive for large transfers — the cost is hidden in the rate.
  • **Wise transparent fee ~0.4–0.7%:** much cheaper for most transfer sizes.
  • **Lumon and Currencies Direct** offer forward contracts for larger amounts.
  • **Forward contracts lock in rate** for a future property purchase — removes exchange risk.
  • **Always compare rates** before any transfer over €5,000.
simplifyExample: |
  British owner paying €32,000 ITP on Mallorca purchase. Needs to send £27,000 from UK. HSBC rate: loses ~£600 in spread. Wise: loses ~£190. Lumon forward contract (booked 6 weeks earlier): rate locked, saves additional £300 vs day-of rate. Total saving vs bank: ~£700.
---
