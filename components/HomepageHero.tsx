          ...
          <div className="grid lg:grid-cols-[1fr_420px] gap-0 lg:gap-16 items-end">
            ...
            <div className="pb-16 lg:pb-20">
              ...
              <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg">
                {de
                  ? '62 praktische Ratgeber zu spanischen Steuern, NIE-Anträgen, Erbschaft, Ferienvermietung und Alltag — in verständlichem Deutsch.'
                  : '62 practical guides on Spanish taxes, NIE applications, inheritance, tourist rentals, and daily life — in plain English.'}
              </p>
